...
CreditActivity.belongsTo(VendorClient, { foreignKey: 'VendorClientID', as: 'vendorClient' });
Vendor.hasMany(VendorClient, { foreignKey: 'VendorID', as: 'vendorClients' });
VendorClient.hasMany(CreditActivity, { foreignKey: 'VendorClientID', as: 'creditActivities' });
